...
urlpatterns = [
    ...
    path('articles/create/', articles_views.article_create_view, name='article-create'),
    path('articles/<slug:slug>/', articles_views.article_detail_view, name='article-detail'),
